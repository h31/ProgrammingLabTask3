...
public class Config {
    public final static String LOGO_IMG = "plane/images/logo.png";
    public final static String SHOOT_BACKGROUND_IMG = "plane/images/shoot_background.png";
    public final static String SHOOT_IMG = "plane/images/shoot.png";
    public final static String FONT_IMG = "plane/images/font.png";
    public final static String BUTTON_BG_IMG = "plane/images/button_bg.png";
    public final static String BUTTON_HOVER_BG_IMG = "plane/images/button_hover_bg.png";

    public final static String ACHIEVEMENT_AUDIO = "plane/sound/achievement.wav";

    public final static String SMALL_PLANE_KILLED_AUDIO = "plane/sound/small_plane_killed.wav";
    public final static String BIG_PLANE_KILLED_AUDIO = "plane/sound/big_plane_killed.wav";
    public final static String BOSS_PLANE_KILLED_AUDIO = "plane/sound/boss_plane_killed.wav";

    public final static String BOSS_PLANE_FLYING_AUDIO = "plane/sound/boss_plane_flying.wav";
    public final static String POP_WEAPON_AUDIO = "plane/sound/pop_weapon.wav";

    public final static String USER_BOMB_AUDIO = "plane/sound/use_bomb.wav";
    public final static String FIRE_BULLET_AUDIO = "plane/sound/fire_bullet.wav";

    public final static String GAME_MUSIC_AUDIO = "plane/sound/game_music.wav";
    public final static String GAME_OVER_AUDIO = "plane/sound/game_over.wav";

    public final static String GET_BOMB_AUDIO = "plane/sound/get_bomb.wav";
    public final static String GET_DOUBLE_LASER_AUDIO = "plane/sound/get_double_laser.wav";

    public final static String BUTTON_ACTION_AUDIO = "plane/sound/button.wav";

    public static final String HELP_FILE_PATH = "plane/help.html";
    ...
    public static int YELLOW_BULLET_MOVE_SPEED = 20;
    public static int BLUE_BULLET_MOVE_SPEED = 50;

    public static int ENEMY_PLANE_MOVE_SPEED_MIN = 10;
    public static int ENEMY_PLANE_MOVE_SPEED_MAX = 20;

    public static int POP_WEAPON_ANIMATION_MOVE_FORWARD_SPEED = 50;
