...
import entity.BigPlane;
import entity.BossPlane;
import entity.EnemyPlane;
import entity.SmallPlane;
import listener.EnemyPlaneListener;
import until.Images;
...
public class EnemyPlaneFactory {
    ...
    public static final EnemyPlane createEnemyPlane(GamePlayingPanel playingPanel, EnemyPlaneType enemyPlaneType) {
        ...
        enemyPlane.addEnemyPlaneListener((EnemyPlaneListener) playingPanel);
        return enemyPlane;
    }
}
